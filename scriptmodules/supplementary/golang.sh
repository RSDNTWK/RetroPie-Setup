...
function install_bin_golang() {
    ...
    printMsgs "console" "Downloading go1.11.8.linux-$arch.tar.gz"
    downloadAndExtract "https://storage.googleapis.com/golang/go1.11.8.linux-$arch.tar.gz" "$md_inst" --strip-components 1
}
