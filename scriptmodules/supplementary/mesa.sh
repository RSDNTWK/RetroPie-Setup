...
function depends_mesa() {
    ...
    local depends=(vulkan-tools libxcb-shm0-dev meson ninja-build libgbm-dev libdrm-dev libpciaccess-dev python3-mako byacc flex pkg-config libx11-dev libxext-dev)
